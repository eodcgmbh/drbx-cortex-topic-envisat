 ...
 */
package envisat.jai.operator;

import fr.gael.drb.DrbFactory;
import fr.gael.drb.DrbNode;
import envisat.jai.operator.Common.PixelCorrection;
...
/**
 * Implements descriptor to register MERIS Quicklook renderer into JAI API.
 */
public class QuicklookMerisDescriptor extends OperationDescriptorImpl
{
   private static final long serialVersionUID = 6162254470790459138L;
   private static Logger LOGGER=Logger.getLogger(QuicklookMerisDescriptor.class);

   /**
    * The "QuicklookMeris" operation name.
    */
   public final static String OPERATION_NAME = "QuicklookMeris";

   /**
    * The resource strings that provide the general documentation and
    * specify the parameter list for the "Meris" operation.
    */
   protected static String[][] resources =
   {
      { "GlobalName", OPERATION_NAME },
      { "LocalName", OPERATION_NAME },
      { "Vendor", "envisat.jai.operator" },
      { "Description", "Performs the rendering of Envisat MERIS dataset." },
   ...
   /**
    * Create the Render Operator to compute Meris quicklook.
    *
   ...
   {
      String envisat_meris_data = args[0];
      String output = args[1];
      
      DrbFactoryResolver.setMetadataResolver(new DrbCortexMetadataResolver());
      DrbNode node = DrbFactory.openURI(envisat_meris_data);
