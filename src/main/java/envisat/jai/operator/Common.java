...
/**
 * Common class gather the MERIS commons implementations and variables.
 */
public class Common
{
   private static Logger LOGGER = Logger.getLogger(QuicklookMeris.class);
    ...
    * <pre>
    * {@code
    * NetcdfDataset ds=NetcdfDataset.openDataset("M08_rho_TOA.nc");
    * VariableEnhanced data = ds.getVariables("M08_rho_TOA");
   ...
   {
      String name=String.format("M%1$02d_rho_TOA", band);
